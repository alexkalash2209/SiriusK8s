...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-24 23-50-01.png>)
...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-05-05.png>)
...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-12-13.png>)

Убедимся что мы PID 1
echo "Мой PID: $$"
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-13-18.png>)

Просмотрим запущенные процессы командой ps aux
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-14-38.png>)
...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-18-24.png>)
...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-24-25.png>)
...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-25-53.png>)

Запустим нагрузку и поместим ее в cgroup:\
stress-ng --cpu 2 --timeout 30s &
echo $! | sudo tee /sys/fs/cgroup/mytest/cgroup.procs
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-27-08.png>)

Проверим, что лимит применился и посмотрим в top:\
cat /sys/fs/cgroup/mytest/cpu.stat\
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-37-56.png>)
top
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-34-42.png>)
Скриншот лимита (cat /sys/fs/cgroup/mytest/cpu.max):
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-40-42.png>)
...
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 00-52-28.png>)

Войдем в chroot-окружение : sudo chroot /tmp/myroot /bin/bash\
![alt text](<../Pictures/Screenshots/Screenshot from 2026-03-25 01-04-45.png>)
